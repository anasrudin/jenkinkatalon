...
docker run -t --rm -v "/%currentdir%:/tmp/source" -w /tmp/source katalonstudio/katalon katalon-execute.sh -browserType="Android" -deviceId="emulator-5554" -retry=0 -statusDelay=15 -testSuitePath="Test Suites/mobile_driverapp/bbg_regressiontest_mobile" -apikey=%apikey%
